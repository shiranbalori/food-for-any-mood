    ...
    if recipe_type == "dessert":
        ...
        if melt_name and len(names) >= 2:
            ...
            return [
                ...
                f"מקררים כ-{chill_minutes} דקות עד שהקינוח מתקשה מספיק לחיתוך.",
